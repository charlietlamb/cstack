...
- [ ] Read these from trunk at program start. Re-read them at every tick.
  - [ ] `cat ~/.agents/skills/poteto-mode/playbooks/<execution playbook>.md`
  - [ ] `cat ~/.agents/skills/swarm/SKILL.md`
  - [ ] `git show origin/main:<control skill path>`
  - [ ] `cat ~/.agents/skills/poteto-mode/playbooks/opening-a-pr.md`
  - [ ] `cat ~/.agents/skills/<each other leaf skill the program uses>`
