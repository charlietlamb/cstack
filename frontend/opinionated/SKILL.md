...
Apply these alongside this skill when relevant. Each lives at `~/.agents/skills/<name>/SKILL.md`.
...
- `emil` for motion and UI polish.
- `break-it` to stress-test a component with worst-case data once it works.
